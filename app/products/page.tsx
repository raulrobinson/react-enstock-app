            ...
            <div className='md:w-[85%] w-full py-4 px-6 min-h-[100vh] bg-[#f4f4f6]'>
               <Header title="Productos"/>
                 <section className="w-full mb-10">
                    <h3 className="text-lg mb-4">Adicionar Producto <span className="text-gray-500 text-sm">(Nombre, precio, categoria)</span></h3>
                    <form className="w-full" onSubmit={handleSubmit}>
                        <div className="flex items-center justify-between space-x-3 mb-4" >
                            <input className="border-b-[1px] px-4 py-2 w-1/3 rounded" type="text" placeholder="Producto" name="product" id="product"
                        ...
                        {category !== "select" ?
                            <button className="py-2 px-4 bg-blue-500 text-white rounded">ADICIONAR PRODUCTO</button> :
                            <p className="text-red-400 text-sm">Es necesario que elijas una Categoria</p>}
                    </form>
                </section>
