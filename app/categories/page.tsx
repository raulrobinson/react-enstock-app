        ...
        <main className='flex w-full min-h-[100vh] relative'>
            ...
            <div className='md:w-[85%] w-full py-4 px-6 min-h-[100vh] bg-[#f4f4f6]'>
                ...
                <section className="w-full mb-10">
                    <h3 className="text-lg mb-4">Adicionar Categoria</h3>
                    <form className="w-full flex items-center space-x-6" onSubmit={handleSubmit}>
                            ...
                            />
                        <button className="py-2 px-4 bg-blue-500 text-white rounded" type="submit">Adicionar Categoria</button>
                    </form>
                </section>
                <div className='w-full min-h-[30vh]'>
                    <h3 className='text-xl'>Categorias <span className='text-blue-300'>({categories?.length})</span></h3>
                    <div>
