  ...
  return (
    <main className="w-full h-[90vh] flex items-center justify-center flex-col px-4"> 
      ...
      <form className="flex flex-col md:w-1/2 w-full mb-8" onSubmit={handleSubmit}>
        ...
        /> 
        <button type="submit" className="p-3 bg-blue-600 hover:bg-blue-800 text-white md:w-[200px] w-full rounded">Ingresar</button>
      </form>
      <p className="text-gray-400 text-center text-sm">&copy; Copyright {new Date().getFullYear()} by <a href="https://github.com/raulrobinson" target="_blank" className="text-blue-300 text-sm">Raul Bolivar</a></p>
    </main>
  )
}
