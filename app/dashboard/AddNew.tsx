        ...
        <div className=" w-full md:p-auto p-4 h-full dim absolute top-0 left-0 z-40 flex items-center justify-center">
            <div className="bg-white md:w-2/3 w-full p-6 rounded-lg shadow-lg overflow-y-auto">
                <section className="mb-4 flex items-center justify-between">
                    <h3 className="text-lg font-bold text-blue-800">Agregar Venta</h3>
                ...
                <form className="flex flex-col" onSubmit={handleSubmit}>
                    <div className="w-full flex items-center space-x-4 mb-6">
                        <div className="w-1/2 flex flex-col">
                         <label htmlFor="customerName" className="text-sm">Nombre Cliente</label>
                        ...
                        <div className="w-1/2 flex flex-col">
                            <label htmlFor="customerEmail" className="text-sm">Email Cliente</label>
                    ...
                    <button className="bg-blue-500 rounded text-white py-2 px-4">GRABAR</button>
                </form>
            </div>
        </div>
    )
